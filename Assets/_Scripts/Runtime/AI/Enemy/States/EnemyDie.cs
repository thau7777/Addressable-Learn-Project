...
public class EnemyDie : State<EnemyController>
{
    ...
    {
        if (Owner.Data.explodeVfxSettings == null) return;
        var fracture = FlyweightFactory.Spawn(Owner.Data.explodeVfxSettings);
    ...
    {
        EventBus<EnemyDeathEvent>.Raise(new EnemyDeathEvent(Owner.transform));
    }
