...
public class StabAttackAnimSO : WeaponAttackAnimSO
{
    ...
    public override Sequence Play(Transform weaponModel, Transform target, Vector3 originLocalPos, float range, Quaternion originLocalRot, float attackInterval, Action onStabStart, Action onStabEnd)
    {
